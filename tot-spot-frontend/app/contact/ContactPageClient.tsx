...
export default function ContactPage({ contactInfo }: { contactInfo: any }) {
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <Link href={`tel:${phone}`}>
                        <p className="text-gray-600 hover:text-pink-600">{phone}</p>
                        </Link>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 hover:text-pink-600">{email}</p>
                        </Link>
                      </div>
                    </div>
                  </div>
